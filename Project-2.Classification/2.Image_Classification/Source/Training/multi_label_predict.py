...
model = tf.keras.models.load_model('/data/backup/pervinco_2020/model/test_model/mlc_test_model3.h5')

test_imgs = sorted(glob.glob('/data/backup/pervinco_2020/datasets/miml_dataset/testset/*.jpg'))
